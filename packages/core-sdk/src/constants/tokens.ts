...
export const USDC: TokenMap = {
  ...
  [ChainId.EVMOS_TESTNET]: new Token(
    ...
    USDC_ADDRESS[ChainId.EVMOS_TESTNET],
    6,
    'USDC',
    'USD Coin'
  ),
...
export const WEVMOS: TokenMap = {
  ...
  [ChainId.EVMOS_TESTNET]: new Token(
    ChainId.EVMOS_TESTNET,
    WEVMOS_ADDRESS[ChainId.EVMOS_TESTNET],
    18,
    'WEVMOS',
    'Wrapped Evmos'
  ),
...
export const FANTA: ChainTokenMap = {
  ...
  [ChainId.EVMOS_TESTNET]: new Token(
    ChainId.EVMOS_TESTNET,
    FANTA_ADDRESS[ChainId.EVMOS_TESTNET],
    18,
    'FANTA',
    'FantasticToken'
  ),
